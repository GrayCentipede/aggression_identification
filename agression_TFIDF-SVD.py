...
vectorizer = Pipeline([#('tfidf', HashingVectorizer(decode_error='ignore', n_features=2 ** 18)),
                        ('tfidf', TfidfVectorizer(binary=True)), #, analyzer='char', ngram_range=(1, 5))),
...
with open("data/agr_en_train.csv") as r:
    vectorizer.fit([x['body'] for x in csv.DictReader(r, 
